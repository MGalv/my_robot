...
This is my version of the exercise  "Toy Robot Simulator".

## How to install Robot

* Extract `myRobot.zip` in your preferred folder.
* Access into the `toy_robot` folder.
* Select o install your preferred Ruby version (Required >=V2.3).
* Execute the app running `ruby lib/load.rb`.
* Follow the instructions, play and enjoy.

# Test suite

In order to run the test suite you will require to install Rspec.

## How to install test suite

* Install Rspec running `gem install rspec`
* Form the root folder, run the test suite `rspec spec/`

# Below you can find the original exercise requests.
